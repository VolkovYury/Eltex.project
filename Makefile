all: server.o client.o products.pb-c.o network.o server_functions.o client_functions.o wrapperfunc.o
	...
	gcc server.o products.pb-c.o network.o server_functions.o wrapperfunc.o -o server -lpthread -L./protobuf-c -lprotobuf-c -Wl,-rpath,./protobuf-c -Wall -Wextra -Werror
server.o: server.c
	gcc server.c -c
client.o: client.c
	gcc client.c -c
